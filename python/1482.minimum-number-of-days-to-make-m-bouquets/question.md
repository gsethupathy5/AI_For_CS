# [1482. Minimum Number of Days to Make m Bouquets][link] (Medium)
...
The garden consists of `n` flowers, the `iᵗʰ` flower will bloom in the `bloomDay[i]` and then can be
