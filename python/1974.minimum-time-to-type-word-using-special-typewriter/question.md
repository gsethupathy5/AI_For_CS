# [1974. Minimum Time to Type Word Using Special Typewriter][link] (Easy)
...
Given a string `word`, return the **minimum** number of seconds to type out the characters in
`word`.
